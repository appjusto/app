...
export const EloIcon = ({ width = 24, height = 24, ...props }: SvgProps) => {
  return (
    <Svg
      width={width}
      height={height}
    ...
    >
      <Path
        d="M41.68,0h698.14c23.027,0,41.68,18.983,41.68,42.42v414.66c0,23.437-18.652,42.42-41.68,42.42H41.68    C18.652,499.5,0,480.517,0,457.08V42.42C0,18.983,18.652,0,41.68,0z"
        fill="#000000"
      />
      <Path
