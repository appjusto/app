...
const iconCheckToast = require('./icons/check-toast.png');
const iconErrorToast = require('./icons/error-toast.png');
...
export const checkToast = iconCheckToast;
export const errorToast = iconErrorToast;
